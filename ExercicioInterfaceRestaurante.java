...
public class ExercicioInterfaceRestaurante extends Pedido {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(pedido.item);
        System.out.println(" " + pedido.preco);
        System.out.print(pedido2.item);
        System.out.println(" " + pedido2.preco);
        System.out.print(pedido3.item);
        System.out.println(" " + pedido3.preco);
